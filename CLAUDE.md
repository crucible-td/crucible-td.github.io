...
npm run diversity -- --slots 18 --sample 720  # how many builds work, and is any tower mandatory
```
...
`npm test` spends almost all of its thirty-odd seconds on one line: the
